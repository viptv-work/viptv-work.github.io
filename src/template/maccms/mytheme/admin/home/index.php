<blockquote class="layui-elem-quote" style="margin: 20px 0;">
	欢迎使用首途【第二十二套】主题，本主题由站长资源（www.zhanzhang114.com）完美剔除授权！
</blockquote>
    ...
    <div class="layui-col-md4" style="padding-right: 20px;">
    	<table class="layui-table">	
		    ...
		    <tbody>
		        ...
		        <tr>
		        	<td>在线客服</td>
		            <td>QQ群：<?php echo($my['qq']) ?></td>
		        </tr>
		        <tr>
		            <td>官网地址</td>
		            <td> <a target="_blank" href="<?php echo($my['website']) ?>">站长资源（www.zhanzhang114.com）</a></td>
		        </tr>
		    </tbody>
		</table>
    </div>
